...
public class AfterLogin extends ListOfEmployees {
    ...
    public void createBtn() {
        ...
        listView.getItems().add(new Employee(addName.getText(),  addBirthDate.getText(), SelectGender.getItems(), SIN, addStartDate.getText(),AddEmailAddress.getText()));
    }
    ...
    public void saveBtn() throws IOException {
        ...
        ObservableList<Employee> myList = listView.getItems();
